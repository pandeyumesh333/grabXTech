  ...
  return (
    <div className="min-h-screen bg-gray-900">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-yellow-500">Our Mission</h2>
      ...
      <div className="py-12 md:py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 md:mb-16 text-yellow-500 text-center">Our Journey</h2>
          <div className="relative">
            ...
            <div className="space-y-8 md:space-y-16">
              {timeline.map((item, index) => (
                ...
                >
                  <div className={`w-full md:w-1/2 ${index % 2 === 0 ? 'md:pl-8 lg:pl-16' : 'md:pr-8 lg:pr-16'}`}>
                    <div className="bg-gray-800 p-4 md:p-6 rounded-xl">
                      <div className="text-indigo-400 font-bold mb-2">{item.year}</div>
                      <h3 className="text-lg md:text-xl font-bold mb-2 text-yellow-500">{item.title}</h3>
      ...
      <div className="py-12 md:py-20 bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 md:mb-16 text-yellow-500 text-center">Our Values</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-gray-900 p-6 md:p-8 rounded-xl text-center">
                <div className="text-indigo-400 mb-4 flex justify-center">{value.icon}</div>
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 text-yellow-500">{value.title}</h3>
